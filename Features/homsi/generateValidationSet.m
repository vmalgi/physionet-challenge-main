...
%data_dir = [pwd filesep '..\training\training-f' filesep];
...
fprintf(['Running score2016Challenge_new.m to get scores on your entry on the validation data in training set....\n'])
