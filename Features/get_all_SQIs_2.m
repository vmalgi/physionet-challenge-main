function  SQI= get_all_SQIs_2(audio_data, Fs,max_HR,min_HR,max_RR,min_RR)
%% Paper Information
...
[~, untruncated_autocorrelation, semi_truncated_autocorrelation] = get_autocorrelation_modified(audio_downsampled_2000_f, Fs_2000);
...
[psd_envelope,psd_original_envelope,~,~] = get_psd_envelope(denoised_signal, Fs_1000);
...
[SQI.mfcc_mean_coeffs,SQI.mfcc_median_coeffs,SQI.mfcc_skew_coeffs]...
    =get_mfcc_features(coeffs_detailed);
...
[~, PCG_filtered] =PCG_filtering_iga(PCG_normalized,1000); 
