...
j=j+1;
 ...
 [ MFCCs_systole{k,1}, FBEs_systole, frames_systole ] = ...
                    mfcc_modified(seperate_systoles{k,1}, Fs, Tw, Ts, alpha, @hamming, [LF HF], M, C+1, L ); 
...
j=j+1;
 ...
 [ MFCCs_diastole{k,1}, FBEs_diastole, frames_diastole ] = ...
                    mfcc_modified(seperate_diastoles{k,1}, Fs, Tw, Ts, alpha, @hamming, [LF HF], M, C+1, L ); 
...
j=j+1;
 ...
 [ MFCCs_s1{k,1}, FBEs_s1, frames_s1 ] = ...
                    mfcc_modified(seperate_s1{k,1}, Fs, Tw, Ts, alpha, @hamming, [LF HF], M, C+1, L ); 
...
j=j+1;
 ...
 [ MFCCs_s2{k,1}, FBEs_s2, frames_s2 ] = ...
                    mfcc_modified(seperate_s2{k,1}, Fs, Tw, Ts, alpha, @hamming, [LF HF], M, C+1, L ); 
