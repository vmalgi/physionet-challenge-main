...
% oryginalne B wyuczone na validation set - daje sens 0,72 i spec 0,70 na validation set
...
% B wyuczone na calym zbiorze treningowym niezbalansowanym daje na validation set sens 0.25, spec 0.94 lacznie 0.60, zbalansowanym sens 0.76 spec 0.56 lacznie 0.66
load B;
