...
[qfactorS1,qfactorS2, bandS1, bandS2, powS1_0_50, powS1_100_200, powSy_0_50, powSy_100_200, powS2_0_50, powS2_100_200, powDia_0_50, powDia_100_200] = qufaktoruj(PCG,A, 1000);
...
%% OUR FEATURES
[meanSumS1, meanSumS2] = powerAbsS1S2(A,PCG);     % moc dla S1 i S2 liczona jako suma wartoœci bezwzglêdnej
% [findRMSSD1, findRMSSD2]  = RMSSD( A, PCG )           % RMSSD dla faz S1 oraz S2
[RMSSD1, RMSSD2, RMSSSYS, RMSSDIAS]  = RMSSD22( PCG, PCGfiltered, A );
std_QT = stdQT(A);                                % odchylenie standardowe d³ugoœci "odcinków QT" = S1 + Systole + S2
meanratioS2S1 = ratioS1S2(A,PCG);                     %  
[m_diff_RR,sd_diff_RR,mean_diff_IntS1,sd_diff_IntS1,mean_diff_IntS2,sd_diff_IntS2,mean_diff_IntSys,sd_diff_IntSys,mean_diff_IntDia,sd_diff_IntDia ]  = roznice( A ); 
...
features = [m_RR sd_RR  mean_IntS1 sd_IntS1  mean_IntS2 sd_IntS2  mean_IntSys sd_IntSys  mean_IntDia sd_IntDia m_Ratio_SysRR sd_Ratio_SysRR m_Ratio_DiaRR sd_Ratio_DiaRR m_Ratio_SysDia sd_Ratio_SysDia ...
    m_Amp_SysS1 sd_Amp_SysS1 m_Amp_DiaS2 sd_Amp_DiaS2 meanSumS1 meanSumS2 RMSSD1 RMSSD2 RMSSSYS RMSSDIAS std_QT meanratioS2S1 ...
    m_diff_RR  sd_diff_RR,mean_diff_IntS1 sd_diff_IntS1 mean_diff_IntS2 sd_diff_IntS2 mean_diff_IntSys sd_diff_IntSys mean_diff_IntDia sd_diff_IntDia...
    qfactorS1   bandS1   powS1_0_50 powS1_100_200 powSy_0_50 powSy_100_200 powS2_0_50 powS2_100_200 powDia_0_50 powDia_100_200];
